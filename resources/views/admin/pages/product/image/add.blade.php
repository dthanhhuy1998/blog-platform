                        ...
                        <div class="box-body">
                            <div class="form-group @error('image') has-error @enderror">
                                ...
                                <div class="preview-image">
                                    <img src="{{ asset('storage/uploads/default.png') }}" alt="Avatar" id="preview">
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td width="10%" align="center">
                                                    <div class="preview-image" style="width: 60px; height: 60px;">
                                                        <img src="@if(!empty($item->image)) {{ asset('storage/' . $item->image) }} @else {{ asset('storage/uploads/default.png') }} @endif" alt="Image">
                                                    </div>
                                                </td>
