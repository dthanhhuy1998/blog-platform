            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group">
                        ...
                        <a href="{{ route('admin.product.image.getAddImage', [$productId]) }}" class="btn btn-default btn-sm" title="Hủy bỏ"><i class="fa fa-undo"></i> Quay lại</a>
                    </div>
                </div>
                <div class="col-md-12">
                        ...
                        <div class="box-body">
                            <div class="form-group @error('image') has-error @enderror">
                                ...
                                <div class="preview-image">
                                    <img src="@if(!empty($image->image)) {{ asset('storage/' . $image->image) }} @else {{ asset('storage/uploads/default.png') }} @endif" alt="Avatar" id="preview">
                                </div>
