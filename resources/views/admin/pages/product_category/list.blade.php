                            ...
                            <tbody>
                                ...
                                @foreach($productCategories as $productCategory)
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">
                                            <a href="{{ route('admin.product.category.getEdit', [$productCategory->id]) }}" class="btn btn-primary btn-sm" title="Chỉnh sửa"><i class="fa fa-edit"></i></a>
                                            <a href="{{ route('admin.product.category.getDelete', [$productCategory->id]) }}" class="btn btn-danger btn-sm" title="Xóa bỏ" onclick="return confirm('Bạn có chắn chắn muốn xóa danh mục này. Xóa?');"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
