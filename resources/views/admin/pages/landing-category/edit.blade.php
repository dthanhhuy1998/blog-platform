...
@section('content')
   <!-- Content Header (Page header) -->
    ...
    <section class="content">
        <form action="{{ route('admin.landing.category.update', $category->id) }}" role="form" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group">
                        ...
                        <a href="{{ route('admin.product.category.getList') }}" class="btn btn-default btn-sm" title="Hủy bỏ"><i class="fa fa-undo"></i> Quay lại</a>
                    </div>
                </div>
                <div class="col-md-12">
                    @if ($errors->any())
                            ...
                            <div class="tab-pane active" id="general">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="preview-image">
                                        <img src="@if(!empty($category->image)) {{ asset('storage/' . $category->image) }} @else {{ asset('storage/app/uploads/default.png') }} @endif" alt="Image" id="preview">
                                    </div>
