...
@section('content')
    <div data-page="page-products.index" id="page-products-index">
        ...
        <section class="content">
            <form action="{{ route('admin.landing.product.store') }}" role="form" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="btn-group">
                            <button type="submit" class="btn btn-primary btn-sm mr-1" title="Lưu lại"><i class="fa fa-save"></i> Lưu lại</button>
                            <a href="{{ route('admin.landing.product.index') }}" class="btn btn-default btn-sm" title="Hủy bỏ"><i class="fa fa-undo"></i> Quay lại</a>
                        </div>
                    </div>
                    <div class="col-md-12">
                        @if ($errors->any())
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="general">
                                    <div class="form-group @error('name') has-error @enderror">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nhập tên sản phẩm" value="{{ old('name') }}" name="name">
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="detail" rows="8" class="form-control" id="editor1" placeholder="Nhập nội dung bài viết">{{ old('detail') }}</textarea>
                                    </div>
                                ...
                                <div class="tab-pane" id="data">
                                    <div class="form-group  @error('sku') has-error @enderror">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nhập mã sản phẩm (Nếu để trống sẽ tự tạo mã)" value="{{ old('sku') }}" name="sku">
                                        @error('sku')
                                            <span class="help-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Tồn kho</label>
                                        <input type="number" class="form-control" placeholder="Nhập số lượng tồn kho" value="{{ old('quantity') }}" name="quantity">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group flex justify-content-center">
                                        <label class="w-100">Sản phẩm nổi bật</label>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="featured" value="1" class="minimal" checked>
                                                Có
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="featured" value="0" class="minimal">
                                                Không
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="status" value="1" checked="" class="minimal">
                                                Đang bán
                                            </label>
                                        </div>
                                        <div class="radio">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="display" value="1" checked class="minimal">
                                                Hiển thị
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="display" value="0" class="minimal">
                                                Ẩn sản phẩm
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="image">
                                    <div class="form-group">
                                        ...
                                        <div class="preview-image">
                                            <img src="{{asset('admin/assets/dist/img/placeholder-upload.jpg')}}" alt="Image" id="imagePreview">
                                        </div>
                                ...
                                <div class="tab-pane" id="links">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nhập đường dẫn sản phẩm" value="{{ old('shopeeLink') }}" name="shopeeLink">
                                    </div>
                                </div>
                            </div>
                            <!-- /.tab-content -->
