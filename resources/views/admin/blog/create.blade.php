                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="general">
                                <div class="form-group @error('title') has-error @enderror">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{__('Enter title')}}" value="{{ old('title') }}" name="title">
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="summary" rows="8" class="form-control textarea" placeholder="{{__('Enter summary')}}">{{ old('summary') }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>{{__('Content')}}</label>
                                    <textarea name="content" rows="8" class="form-control" id="editor1" placeholder="{{__('Enter content')}}">{{ old('content') }}</textarea>
                                </div>
                                <div class="form-group">
